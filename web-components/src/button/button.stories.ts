...
export const Appearance = renderComponent(html<ButtonStoryArgs>`
  <section style="display:flex;gap:0.25rem;flex-wrap:wrap;">
...
export const Size = renderComponent(html<ButtonStoryArgs>`
  <section style="display:flex;gap:0.25rem;flex-wrap:wrap;">
    <fpsfa-button size="tiny">Tiny</fpsfa-button>
    <fpsfa-button size="tiny" icon
      ><svg
        fill="currentColor"
        slot="start"
        aria-hidden="true"
      ...
      Tiny with calendar icon</fpsfa-button
    >
    <fpsfa-button size="tiny" icon-only aria-label="Tiny icon only button"
      ><svg
        fill="currentColor"
        aria-hidden="true"
        width="1em"
