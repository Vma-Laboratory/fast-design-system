...
import { AccordionItemExpandIconPosition, AccordionItemSize } from '../accordion-item/accordion-item.options';
import type { Accordion as FpsfaAccordion } from './accordion';
import './define';
import '../accordion-item/define';

type AccordionStoryArgs = Args & FpsfaAccordion;
...
const storyTemplate = html<AccordionStoryArgs>`
  <fpsfa-accordion expand-mode=${x => x.expandMode}>
    <fpsfa-accordion-item
      size=${x => x.size}
