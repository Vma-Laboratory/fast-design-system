...
import { RadioGroup as FpsfaRadioGroup } from './radio-group';
import './define';
import '../radio/define';

type RadioGroupStoryArgs = Args & FpsfaRadioGroup;
...
const storyTemplate = html<RadioGroupStoryArgs>`
  ...
  >
    ...
    <fpsfa-radio ?checked="${x => x.checked}" value="apple">Apple</fpsfa-radio>
    <fpsfa-radio value="pear">Pear</fpsfa-radio>
    <fpsfa-radio value="banana">Banana</fpsfa-radio>
    <fpsfa-radio value="orange">Orange</fpsfa-radio>
  </fpsfa-radio-group>
`;
...
export const RadioGroupLabelledby = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group aria-labelledby="label-2" name="radio-story">
    <span id="label-2" slot="label">Favorite Fruit</span>
    <fpsfa-radio value="apple">Apple</fpsfa-radio>
    <fpsfa-radio value="pear">Pear</fpsfa-radio>
    <fpsfa-radio value="banana">Banana</fpsfa-radio>
    <fpsfa-radio value="orange">Orange</fpsfa-radio>
  </fpsfa-radio-group>
...
export const RadioGroupLayoutVertical = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group aria-labelledby="label-3" orientation="vertical" name="radio-story">
...
export const RadioGroupLayoutHorizontal = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group aria-labelledby="label-4" orientation="horizontal" name="radio-story">
...
export const RadioGroupLayoutHorizontalStacked = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group stacked aria-labelledby="label-5" orientation="horizontal" name="radio-story">
...
export const RadioGroupDefaultChecked = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group aria-labelledby="label-6" orientation="horizontal" name="radio-story">
    <span id="label-6" slot="label">Favorite Fruit</span>
    <fpsfa-radio value="apple">Apple</fpsfa-radio>
    <fpsfa-radio checked value="pear">Pear</fpsfa-radio>
    <fpsfa-radio value="banana">Banana</fpsfa-radio>
    <fpsfa-radio value="orange">Orange</fpsfa-radio>
  </fpsfa-radio-group>
`);
...
export const RadioGroupDisabled = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group disabled aria-labelledby="label-7" name="radio-story">
...
export const RadioGroupDisabledItem = renderComponent(html<RadioGroupStoryArgs>`
  <fpsfa-radio-group aria-labelledby="label-8" name="radio-story">
    <span id="label-8" slot="label">Favorite Fruit</span>
    <fpsfa-radio id="baby" checked value="apple">Apple</fpsfa-radio>
    <fpsfa-radio disabled value="pear">Pear</fpsfa-radio>
    <fpsfa-radio value="banana">Banana</fpsfa-radio>
    <fpsfa-radio value="orange">Orange</fpsfa-radio>
  </fpsfa-radio-group>
`);
...
const getLabelContent = (): string | undefined => {
  const radioGroup = document.querySelector('#radio-group-fruit') as FpsfaRadioGroup;
