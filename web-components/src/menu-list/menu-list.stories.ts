...
import type { MenuList as FpsfaMenuList } from './menu-list';
import './define';
import '../menu-item/define';
import '../divider/define';

type MenuListStoryArgs = Args & FpsfaMenuList;
...
const storyTemplate = html<MenuListStoryArgs>`
  <div style="width: 200px; height: 13em;">
    <fpsfa-menu-list>
      <fpsfa-menu-item ?disabled=${x => x.disabled}>
        Item 1
      ...
      <fpsfa-menu-item ?disabled=${x => x.disabled}> Open </fpsfa-menu-item>

      <fpsfa-divider role="separator" aria-orientation="horizontal" orientation="horizontal"></fpsfa-divider>

      <fpsfa-menu-item role="menuitemcheckbox" ?disabled=${x => x.disabled}>
        Checkbox 1
      ...
      <fpsfa-menu-item role="menuitemcheckbox" ?disabled=${x => x.disabled}> Checkbox 3 </fpsfa-menu-item>

      <fpsfa-divider role="separator" aria-orientation="horizontal" orientation="horizontal"></fpsfa-divider>

      <fpsfa-menu-item role="menuitemradio" ?disabled=${x => x.disabled}>
        Radio 1
        <span slot="start">${Cut20Filled}</span>
      </fpsfa-menu-item>
      ...
      <fpsfa-menu-item role="menuitemradio" ?disabled=${x => x.disabled}> Radio 3 </fpsfa-menu-item>
...
export const MenuListWithCheckboxSelection = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative;">
    <fpsfa-menu-list>
      <fpsfa-menu-item role="menuitemcheckbox"> Item 1 </fpsfa-menu-item>
      <fpsfa-menu-item role="menuitemcheckbox"> Item 2 </fpsfa-menu-item>
      <fpsfa-menu-item role="menuitemcheckbox"> Item 3 </fpsfa-menu-item>
    </fpsfa-menu-list>
  </div>
`);
...
export const MenuListWithRadioSelection = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative">
    <fpsfa-menu-list>
      <fpsfa-menu-item role="menuitemradio"> Item 1 </fpsfa-menu-item>
      <fpsfa-menu-item role="menuitemradio"> Item 2 </fpsfa-menu-item>
      <fpsfa-menu-item role="menuitemradio"> Item 3 </fpsfa-menu-item>
    </fpsfa-menu-list>
  </div>
`);
...
export const MenuListWithIcons = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative">
    <fpsfa-menu-list>
      <fpsfa-menu-item> Item 1 </fpsfa-menu-item>
      <fpsfa-menu-item>
        Item 2
        <span slot="start">${Edit20Filled}</span>
      </fpsfa-menu-item>
...
export const MenuListWithIconsAndSelection = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative;">
    <fpsfa-menu-list>
      <fpsfa-menu-item role="menuitemcheckbox">
        Item 1
        <span slot="start">${Cut20Filled}</span>
      </fpsfa-menu-item>
      <fpsfa-menu-item role="menuitemcheckbox">
  ...
  <div style="width: 260px; position: relative;">
    <fpsfa-menu-list>
      <fpsfa-menu-item>
        Item 1
        <fpsfa-menu-list slot="submenu">
          <fpsfa-menu-item> Subitem 1 </fpsfa-menu-item>
          <fpsfa-menu-item> Subitem 2 </fpsfa-menu-item>
        </fpsfa-menu-list>
      </fpsfa-menu-item>
      <fpsfa-menu-item>
        Item 2
      ...
      <fpsfa-menu-item>Item 3</fpsfa-menu-item>
    </fpsfa-menu-list>
  </div>
`);
...
export const MenuListAligningWithDivider = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative">
    <fpsfa-menu-list>
      <fpsfa-menu-item> Item 1 </fpsfa-menu-item>
      <fpsfa-menu-item> Item 2 </fpsfa-menu-item>
      <fpsfa-divider role="separator" aria-orientation="horizontal" orientation="horizontal"></fpsfa-divider>

      <fpsfa-menu-item> Item 3 </fpsfa-menu-item>
      <fpsfa-menu-item> Item 4 </fpsfa-menu-item>
    </fpsfa-menu-list>
  </div>
`);
