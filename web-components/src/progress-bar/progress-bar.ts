...
import type { ProgressBarShape, ProgressBarThickness, ProgressBarValidationState } from './progress-bar.options';

/**
 * The base class used for constructing a fpsfa-progress-bar custom element
 * @public
 */
